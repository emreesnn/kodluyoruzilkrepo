...
![kodluyoruzilkrepo](https://github.com/emreesnn/kodluyoruzilkrepo/blob/master/png/gitFirstRepo.PNG)
...
```bash
git clone https://github.com/emreesnn/kodluyoruzilkrepo.git
```
